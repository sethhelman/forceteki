...
import { ITakeControlProperties, TakeControlSystem } from './TakeControlSystem';
...
// }
export function takeControl<TContext extends AbilityContext = AbilityContext>(propertyFactory: PropsFactory<ITakeControlProperties, TContext>) {
    return new TakeControlSystem(propertyFactory);
}
