...
const { Locations, EffectNames, CardTypes, PlayTypes, ConflictTypes, EventNames } = require('../Constants.js');
...
class DeckCard extends BaseCard {
    ...
    getContributionToImperialFavor() {
        ...
        const contributesGlory = canConributeWhileBowed || !this.exhausted;
